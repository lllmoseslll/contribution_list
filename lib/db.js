...
export function getPool() {
  ...
  if (pool && lastConnectionString === connectionString) return pool;
...
export async function ensureSchema() {
  ...
  schemaReady = query(`
    ...
    CREATE INDEX IF NOT EXISTS committee_members_created_at_idx ON committee_members (created_at ASC);
    ALTER TABLE committee_members ADD COLUMN IF NOT EXISTS role TEXT NOT NULL DEFAULT '';
    ...
    CREATE TABLE IF NOT EXISTS notifications (
      ...
      amount NUMERIC,
      item TEXT,
      general_fund_amount NUMERIC NOT NULL DEFAULT 0,
    ...
    ALTER TABLE notifications ADD COLUMN IF NOT EXISTS general_fund_amount NUMERIC NOT NULL DEFAULT 0;
